...
<body style="margin:1px;" id="ff">
	<table id="dg" title="图片信息管理" class="easyui-datagrid" pagination="true"
		...
		url="${pageContext.request.contextPath}/admin/pictures/datagrid?type=1&grade=1"
		toolbar="#tb">
			...
			<div
				...
				<div id="i_do_wrap">
					...
					<div class="i_do_div rel" id="i_no_sku_stock_wrap">
						...
						<input type="text" id="pictureUrl" name="url" value=""
							required="true" class="easyui-validatebox"
							style="border:1px #9c9c9c solid;height:25px;" /> <input
							id="pictureId" name="id" type="hidden" value="0"> <input
							type="hidden" name="time" id="time" />
					</div>
				</div>
			</div>
		</form>
...
<script type="text/javascript">
	var url = "${pageContext.request.contextPath}/admin/pictures";
	var method;
