...
<body style="margin:1px;" id="ff">
	<table id="dg" title="文本信息管理" class="easyui-datagrid" pagination="true"
		...
		url="${pageContext.request.contextPath}/admin/articles/datagrid"
		toolbar="#tb">
		<thead data-options="frozen:true">
			<tr>
				...
				<th field="content" width="70" align="center" formatter="formatHref">操作
				</th>
			</tr>
		</thead>
	</table>
			...
			<table cellspacing="8px">
				<tr>
					...
					<td><input type="text" id="title" name="articleTitle"
						...
						color="red">*</font> <input id="articleIdfm" name="id"
	...
	<script type="text/javascript">
			...
			KindEditor.ready(function(K) {
				this.editor = K.create('textarea[id="editor"]', {
					items : [ 'source', '|', 'undo', 'redo', '|', 'preview',
							...
							'removeformat', '|', 'multiimage', 'table', 'hr',
		...
		function formatHref(val, row) {
			return "<a href='${pageContext.request.contextPath}/article.html?id="
